...
//  schema  = "{\"type\":\"record\",\"name\":\"paymentsxuxa\",\"namespace\":\"my.examples\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"double\"}]}"
//}
//
...
//resource "schemaregistry_config" "schema_sample_config" {
//  subject = "com.test.myapp.test-from-string"
//  config  = "{\"compatibility\":\"FORWARD\"}"
//}
